...
sudo ovs-ofctl add-flow s1 nw_src=10.0.0.1,nw_dst=224.1.1.1,idle_timeout=0,ip,actions=output:1,output:2,output:3,output:4
sudo ovs-ofctl add-flow s1 nw_src=10.0.0.2,nw_dst=224.1.1.1,idle_timeout=0,ip,actions=output:1,output:2,output:4
...
sudo ovs-ofctl add-flow s2 nw_src=10.0.0.1,nw_dst=224.1.1.1,idle_timeout=0,ip,actions=output:1,output:2
sudo ovs-ofctl add-flow s2 nw_src=10.0.0.2,nw_dst=224.1.1.1,idle_timeout=0,ip,actions=output:1,output:2
...
sudo ovs-ofctl add-flow s3 nw_src=10.0.0.1,nw_dst=224.1.1.1,idle_timeout=0,ip,actions=output:1,output:2
sudo ovs-ofctl add-flow s3 nw_src=10.0.0.2,nw_dst=224.1.1.1,idle_timeout=0,ip,actions=output:1,output:2,output:3
